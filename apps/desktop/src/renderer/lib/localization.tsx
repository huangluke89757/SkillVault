...
const zhCN: Record<string, string> = {
  ...
  "agent:": "个 Agent：",
  "Configure your SkillVault Desktop preferences.": "配置 SkillVault 桌面版偏好。",
  Language: "界面语言",
  ...
  Privacy: "隐私",
  Telemetry: "遥测",
  "Send anonymous usage data to help improve SkillVault": "发送匿名使用数据，帮助改进 SkillVault",
  Updates: "更新",
  ...
  "SkillVault will scan direct skill folders and project-local tool paths inside these roots.": "SkillVault 会扫描这些根目录下的技能文件夹和项目级工具路径。",
  Add: "添加",
  ...
  "Add folders that SkillVault should crawl for direct skill bundles and project-local tool skill directories.": "添加需要扫描的目录，以发现独立技能包和项目级 Agent 技能目录。",
  "Bring Your Own Skill Folders": "添加自己的技能目录",
  "Point SkillVault at places like `~/projects`, `~/workspaces`, or `~/my-skills`. It will discover:": "可添加 `~/projects`、`~/workspaces` 或 `~/my-skills` 等目录，SkillVault 将发现：",
...
const zhToEn: Record<string, string> = {
  ...
  "无法读取迁移包，请选择有效的 .skillvault 文件":
    "Cannot read the package; choose a valid .skillvault file",
