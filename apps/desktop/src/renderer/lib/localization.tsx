...
const zhToEn: Record<string, string> = {
  ...
  "搜索技能（名称 / 作者）": "Search skills (name / author)",
  搜索结果: "Results",
  "搜索结果 · 按安装量排序": "Results · sorted by installs",
  输入技能名称或作者开始搜索: "Type a skill name or author to search",
  "输入技能名称或作者开始搜索（至少 2 个字）":
    "Type a skill name or author to search (2+ characters)",
  热门: "Trending",
  热门排行: "Trending ranking",
  仅官方: "Official only",
  全部: "All",
  效率: "Productivity",
  其他: "Other",
  组合方案: "Combo plan",
  "按顺序串成一条协作流程": "Chained into one workflow, in order",
  提示词用法: "Prompt usage",
  复制: "Copy",
  复制提示词: "Copy prompt",
  复制组合提示词: "Copy combo prompt",
  技能介绍: "About this skill",
