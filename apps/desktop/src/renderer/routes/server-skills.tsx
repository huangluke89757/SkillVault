          ...
          {loading ? (
            ...
            <div className="flex flex-col gap-0.5">
              {skills.map((skill) => (
                ...
                >
                  <span data-no-localize className="text-[12px] font-medium truncate w-full">
                    {skill.name}
                  </span>
                  {skill.description && (
                    <span data-no-localize className="text-[11px] text-muted truncate w-full mt-0.5">
                      {skill.description}
                    </span>
                  )}
                </button>
          ...
          <div className="max-w-3xl px-8 py-6">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between gap-3 mb-2">
                ...
                <h1 data-no-localize className="text-xl font-bold text-foreground">
                  {selectedSkill.name}
                </h1>
              ...
              <p data-no-localize className="text-[12px] text-muted font-mono">
