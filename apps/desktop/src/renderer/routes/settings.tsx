  ...
  return (
    <div className="p-8">
      ...
      <p className="text-[12px] text-muted mb-6">
        Configure your SkillVault Desktop preferences.
      </p>
        ...
        <section>
          ...
          <div className="flex flex-col gap-3">
            {settingsLoaded && (
              <SettingToggle
                label="Telemetry"
                description="Send anonymous usage data to help improve SkillVault"
          ...
          <div className="flex flex-col gap-3">
            <div className="rounded-lg border border-border bg-surface p-3">
              ...
              <p className="text-[12px] text-muted mb-3">
                SkillVault will scan direct skill folders and project-local tool paths inside these roots.
              </p>
        ...
        <section>
          ...
          <div className="p-3 rounded-lg border border-border bg-surface">
            <p className="text-sm text-foreground">
              SkillVault Desktop v{appVersion || "0.1.6"}
            </p>
            <p className="text-[12px] text-muted mt-1">
