              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <span data-no-localize className="text-sm font-medium text-foreground truncate">
                      {server.label}
                    </span>
                    <span data-no-localize className="text-[12px] text-muted font-mono">
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="flex items-center gap-3 mt-0.5">
                        <span className={`text-[12px] ${dotClass[status.dotColor]}`}>
                          {status.text}
                        </span>
                        ...
                        {testResult && (
                          <span
                            className={`text-[11px] ${testResult.ok ? "text-emerald-400" : "text-red-400"}`}
                          >
                            {testResult.ok
                              ? "Connection OK"
                ...
                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    title="Browse skills"
                    className="px-2 py-1.5 rounded-md text-[12px] font-medium text-muted hover:text-foreground hover:bg-background transition-colors"
                  >
                    Browse
                  </button>
                  <button
                    ...
                    className="px-2 py-1.5 rounded-md text-[12px] font-medium text-muted hover:text-foreground hover:bg-background transition-colors disabled:opacity-40"
                  >
                    {isTesting ? "..." : "Test"}
                  </button>
                  <button
                    ...
                    className="px-2.5 py-1 rounded-md text-[12px] font-medium border border-border text-foreground hover:bg-background transition-colors disabled:opacity-40"
                  >
                  ...
                  <button
                    ...
                    title="Delete server"
                    className="px-2 py-1.5 rounded-md text-[12px] font-medium text-red-400 hover:text-red-300 hover:bg-background transition-colors"
                  >
                    Delete
                  </button>
                </div>
                ...
                {syncResult && syncResult.ok && (
                  <div className="flex items-start gap-2 px-3 py-2 rounded-md bg-emerald-500/10 border border-emerald-500/20 text-[12px] text-emerald-400">
                ...
                {syncResult && !syncResult.ok && (
                  <div className="flex items-start gap-2 px-3 py-2 rounded-md bg-red-500/10 border border-red-500/20 text-[12px] text-red-400 break-words">
