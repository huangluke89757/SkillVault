...
export function UpdateNotifier() {
  ...
  const releaseUrl =
    notes?.url ||
    (targetVersion
      ? `https://github.com/huangluke89757/SkillVault/releases/tag/desktop-v${targetVersion}`
      ...
      {open && (
        ...
        >
          <div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="skillvault-update-title"
          ...
          >
            <header className="flex items-start justify-between gap-5 border-b border-border px-6 py-5">
              <div>
                ...
                <h2 id="skillvault-update-title" className="mt-2 text-[21px] font-semibold leading-tight text-foreground">
            ...
            {hasUpdate && (
              <div className="px-6 pb-1 pt-5">
                ...
                {notesLoading ? (
                  ...
                  <div
                    className="skillvault-release-notes skillvault-release-notes--compact mt-3 max-h-48 overflow-y-auto text-[12px] text-foreground"
