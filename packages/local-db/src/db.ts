...
/** Default database path: ~/.skillvault/skillvault.db */
export const DB_PATH = path.join(os.homedir(), ".skillvault", "skillvault.db")
 ...
 *   import { openLocalDb, DB_PATH } from "@skillvault/local-db"
...
export function openLocalDb(driver: SqliteDriver): LocalDb {
  // Ensure the ~/.skillvault/ directory exists
