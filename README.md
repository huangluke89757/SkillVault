...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/local--first-PRIVATE-4E6E76" alt="本地优先" />
  <img src="https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-08141B" alt="Windows、macOS、Linux" />
  <img src="https://img.shields.io/badge/license-MIT-08141B" alt="MIT License" />
</p>

<p align="center">
  <img src="docs/images/skillvault-overview.png" width="100%" alt="SkillVault 本地 Skill 管理界面" />
</p>
...
- **按锁文件更新**：追踪每个 Skill 的来源，可从上游更新或锁定到可信版本
- **离线可用**：已安装 Skill、中文描述和本地管理功能无需联网

<p align="center">
  <img src="docs/images/skillvault-agent-adaptation.png" width="100%" alt="SkillVault 多 Agent 适配" />
</p>

<p align="center">
  <img src="docs/images/skillvault-migration.png" width="100%" alt="SkillVault 导入导出迁移" />
</p>
